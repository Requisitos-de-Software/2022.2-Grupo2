...
O presente artefato apresenta os resultados a verificação do artefato: Backlog, elaborado pelo grupo 2, e disponível [neste link](../modelagem/agil/backlog.md).
...
ID | Questão | Resposta | Comentários
:-: | - | :-: | -
1 | Informa a metodologia para a criação do documento? | Sim |
2 | Existe rastreabilidade dos requisitos? | Sim |
3 | As histórias de usuário seguem algum modelo ou padrão? | Sim |
4 | O Backlog possui épicos bem definidos? | Sim |
5 | O Backlog possui temas bem definidos? | Sim |
6 | Os épicos do backlog estão na forma de histórias de usuário que podem ser mais específicas? | Sim |
7 | Os épicos e histórias de usuário estão corretamente relacionados? | Sim |
