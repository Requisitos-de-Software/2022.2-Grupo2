...
O presente artefato apresenta os resultados a verificação do artefato: NFR Framework, elaborado pelo grupo 2, e disponível [neste link](../modelagem/nfr_framework.md).
...
| 6 | As tabelas e imagens possuem legenda, fonte e são introduzidas no texto? | Não | A primeira tabela está sem legenda e não é introduzida no texto.
...
ID | Questão | Resposta | Comentários
:-: | - | :-: | -
1 | Os softgoals condizem com o contexto? | Sim |
2 | Os softgoals representam metas bem definidas? | Sim |
3 | Os impactos foram corretamente propagados? | Não |
4 | Possui os diagramas dos softgoals? | Sim |
5 | Os diagramas possuem legenda? | Sim |
6 | Há a definição dos softgoals que foram abordados no NFR? | Sim |
7 | Os diagramas usam corretamente os sinais escolhidos? | Sim |
8 | Dá pra ver o passo a passo de um softgoal até chegar em um requisito não funcional? | Sim |
