...
O presente artefato apresenta os resultados a verificação do artefato: Entrevista, elaborado pelo grupo 2, e disponível [neste link](../elicitacao/entrevista.md).
...
ID | Questão | Resposta | Comentários
:-: | - | :-: | -
1 | Os requisitos elicitados são verificáveis? | Não | Os requisitos ENT01 e ENT03 não são verificáveis.
...
8 | Os requisitos possuem identificador de acordo com o padrão ("ENT01")? | Sim |
9 | A técnica de entrevista está descrita? | Sim |
10 | As perguntas da entrevista estão registradas? | Sim |
