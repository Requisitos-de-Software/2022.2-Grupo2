...
O presente artefato apresenta os resultados a verificação do artefato: Storytelling, elaborado pelo grupo 2, e disponível [neste link](../elicitacao/storytelling.md).
...
A verificação de padronização visa determinar se o artefato está de acordo com o padrão do projeto, e tem
...
| 6 | As tabelas e imagens possuem legenda, fonte e são introduzidas no texto? |  Não | A tabela 1 não é introduzida no texto.
...
ID | Questão | Resposta | Comentários
:-: | - | :-: | -
1 | Os requisitos elicitados são verificáveis? | Não | Não são verificáveis, por exemplo, os requisitos ST01, ST13, S15.
...
5 | Os requisitos foram priorizados? | Sim | A priorização está em outra página e não existe link para ela.
...
8 | Os requisitos possuem identificador de acordo com o padrão ("ST01")? | Sim |
9 | As histórias são baseadas nas características das personas? | Sim |
10 | As histórias estão em formato de narração? | Sim |
11 | Os requisitos foram elicitados a partir das histórias? | Sim |
